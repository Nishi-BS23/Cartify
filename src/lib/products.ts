...
export const products: Product[] = [
  {
    ...
    attributes: {
      condition: [
        { value: "New", quantity: 1 },
        { value: "Refurbished", quantity: 1 },
      ],
      color: [
        { value: "Space Gray", quantity: 2 },
        { value: "Silver", quantity: 1 },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    attributes: {
      switchType: [
        { value: "Cherry MX Red", quantity: 5 },
        { value: "Cherry MX Blue", quantity: 4 },
      ],
      color: [{ value: "Black", quantity: 3 }],
    },
  },
  {
    id: "4",
